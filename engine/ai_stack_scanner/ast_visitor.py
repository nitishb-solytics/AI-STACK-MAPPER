...
class FileVisitor(ast.NodeVisitor):
    ...
    def _classify_call(self, node: ast.Call):
        ...
        if name and name in CONSTRUCTOR_REGISTRY:
            ...
            if name == "Client" and package in PACKAGE_REGISTRY and display == "Generic LLM client (verify provider)":
                category, base_display = PACKAGE_REGISTRY[package]
                display = f"{base_display} client"
